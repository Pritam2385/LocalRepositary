...
public class ExampleofVoid {
	...
	public static void main(String[] args) {
		...
		//m1=new Method03();//yes,object got created and with the help m1 reference we can access it's members
			//or
		ExampleofVoid m2=new ExampleofVoid();//yes,object got created and with the help m1 reference we can access it's members
		System.out.println("age: "+m2.age);//age=0
		m2.display();//age=0
		m2.display(25);//age=25		
		System.out.println("age: "+m2.age);//25
		
		ExampleofVoid m3=new ExampleofVoid();//yes,object got created and with the help m1 reference we can access it's members
